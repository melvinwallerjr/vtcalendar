...
$lang['color_label_tabgrayed'] = "Grayed Tab";
$lang['color_description_tabgrayed'] = "Background color for navigation tabs that are not selected.";
...
function LoadVariables() {
	...
	if (!isset($_POST['TabGrayed']) || !setVar($GLOBALS['Color_TabGrayed'], $_POST['TabGrayed'],'color')) { if (isset($_POST['TabGrayed'])) $VariableErrors['TabGrayed'] = $_POST['TabGrayed']; $GLOBALS['Color_TabGrayed'] = $_SESSION['COLOR_TABGRAYED']; };
