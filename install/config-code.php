...
if (isset($_POST['LDAP_MAINADMINS'])) { $Form_LDAP_MAINADMINS = $_POST['LDAP_MAINADMINS']; } else { $Form_LDAP_MAINADMINS = ''; }
...
if (isset($_POST['AUTH_HTTP_MAINADMINS'])) { $Form_AUTH_HTTP_MAINADMINS = $_POST['AUTH_HTTP_MAINADMINS']; } else { $Form_AUTH_HTTP_MAINADMINS = ''; }
...
function BuildOutput(&$ConfigOutput) {
	...
	$ConfigOutput .= '// If you are hosting more than one VTCalendar on your server, you may want to set this to this calendar\'s path.'."\n";
