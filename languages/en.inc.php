...
$lang['view_entries_from'] = 'View entries from';
...
$lang['subscribe_message'] = '<p>There are three ways you can download or subscribe to events from this calendar:</p>
<div class="pad">
...
$lang['export_maxevents_error'] = 'You must enter a number between 1 and 100.';
$lang['export_maxevents_rangemessage'] = 'Must be a number from 1 to 100';
...
$lang['export_showwebmap'] = 'Show Web Map Link';
$lang['export_showwebmap_description'] = 'You may show or hide the Web Map link in the returned events.<br />
This can be done if you have a limited amount of space on your web site.';
...
$lang['ending_time_not_required'] = '(ending time is NOT required, events that continue past midnight should be noted in the description)';
...
$lang['webmap_description'] = 'Optionally provide a Web Map address for the event (e.g. <a href="http://maps.google.com/" target="_blank">Google</a>, <a href="http://maps.yahoo.com/" target="_blank">Yahoo!</a>, <a href="http://www.bing.com/maps/" target="_blank">Bing</a>, <a href="http://www.mapquest.com/" target="_blank">MapQuest</a>, etc.)';
...
$lang['manage_templates_description'] = 'Event templates are a time-saving tool that allows you to quickly create events that have the same basic information.';
...
$lang['featured_search_keywords_message'] = 'Below you can associate certain search keywords with custom text<br />
...
<li><a href="http://www.htmlhelp.com/tools/validator/problems.html#amp" target="_blank">All content, including links, should be HTML encoded</a> to prevent errors.</li>
...
$lang['html_encode'] = 'Please HTML encode content to prevent errors.';
$lang['html_empty'] = 'Default Language cannot have empty fields.';
$lang['lang_default'] = 'Default Language';
$lang['lang_to_modify'] = 'Language to Modify';
$lang['var_name_val'] = 'variable name and value';
...
$lang['import_error_webmap'] = 'Error!: &lt;webmap&gt; is invalid.';
...
$lang['debug_enable'] = 'Enable Debug Mode';
$lang['debug_disable'] = 'Disable Debug Mode';
$lang['debug_description'] = 'Debug mode allows only the current administrative session to view the translation, session, and query information on each page for tracing and diagnosing problems in the calendar.';
?>
