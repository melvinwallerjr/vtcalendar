<?php
# >> Common: Text that may be used by all scripts.
$lang['lang'] = 'en';
...
# >> Main: Text used by main.php and its includes (main_*.inc.php).
...
<p>There are three ways you can download or subscribe to events from this calendar:</p>
<div class="pad">
<p><b>RSS Feed:</b> Automatically receive a list of upcoming events to your Web browser (i.e. <a href="http://www.mozilla.com/en-US/firefox/" target="_blank">Firefox</a> or <a href="http://www.microsoft.com/windows/downloads/ie/getitnow.mspx" target="_blank">Internet Explorer 7+</a>) or news reader (i.e. <a href="http://www.google.com/reader/view/" target="_blank">Google Reader</a>).</p>
<p><b>iCal Subscribe:</b> Some desktop calendars (i.e. <a href="http://www.apple.com/ical/" target="_blank">Apple\'s iCal</a> or <a href="http://www.mozilla.org/projects/calendar/" target="_blank">Mozilla Calendar</a>), or PDAs compatible with the iCalendar standard, can subscribe to a calendar and automatically receive events.</p>
<p><b>iCal Download:</b> If your calendar software (i.e. Outlook) does not support subscribing via iCal, you may be able to manually download events by either clicking the &quot;<i>iCal Download</i>&quot; links below, or by clicking the &quot;<i>copy this event into your personal desktop calendar</i>&quot; link which you will find on each page that lists event details.</p>
</div><!-- .pad -->';
...
$lang['export_errorsfound'] = 'Some errors were found with the information you submitted.<br />
Scroll down to view the errors.';
...
$lang['export_dates_from_description'] = 'Leave blank for no start date, enter a date in <code>YYYY-MM-DD</code> format,<br />
enter &quot;today&quot; to use today\'s date, or enter &quot;upcoming&quot; to only show upcoming events.';
$lang['export_dates_from_error'] = 'You must either a &quot;From&quot; date in <code>YYYY-MM-DD</code> format, leave it blank for no &quot;From&quot; date, enter &quot;today&quot; to use today\'s date, or enter &quot;upcoming&quot; to only show upcoming events.';
$lang['export_dates_to'] = 'To';
$lang['export_dates_to_description'] = 'Leave blank for no end date, enter a date in <code>YYYY-MM-DD</code> format,<br />
or enter a number to represent the number of days after the &quot;From&quot; date.';
$lang['export_dates_to_error'] = 'You must a &quot;To&quot; date in <code>YYYY-MM-DD</code> format, leave it blank for no &quot;To&quot; date, or enter a number to represent the number of days after the &quot;From&quot; date.';
$lang['export_dates_missingfrom'] = 'If you enter a &quot;To&quot; date you must also enter a &quot;From&quot; date.';
...
$lang['export_showdatetime_description'] = 'You may show or hide the date and time in the returned events.<br />
This can be done if you have a limited amount of space on your web site.<br /><br />
<i>Note:</i> It is recommended to show the date and time.';
$lang['export_showlocation'] = 'Show Location';
$lang['export_showlocation_description'] = 'You may show or hide the location in the returned events.<br />
This can be done if you have a limited amount of space on your web site.';
$lang['export_showallday'] = 'Show &quot;All Day&quot;';
$lang['export_showallday_description'] = 'If an event is all day (aka: it does not have a start time) you may show or hide the &quot;All Day&quot; text.<br />
This helps to keep the event listing clean if you have a lot of events that are all day.<br /><br />
Note: It is recommended to show &quot;All Day&quot;.';
$lang['export_maxtitlechars'] = 'Maximum Characters for the Title';
$lang['export_maxtitlechars_description'] = 'If you have a limited amount of space on your web site, you may limit the length of the event title.<br />
Any titles that are beyond this length will be truncated and an ellipse (&hellip;) will be added to the end.';
...
$lang['export_maxlocationchars_description'] = 'If you have a limited amount of space on your web site, you may limit the length of the event location.<br />
Any locations that are beyond this length will be truncated and an ellipse (&hellip;) will be added to the end.';
...
$lang['export_preview_download_text'] = 'To save the exported events, <a href="%URL%" onclick="return false;">right-click this link</a> (CTRL-click on a Mac) and select &quot;Save Target As&hellip;&quot; or &quot;Save Link As&hellip;&quot;';
...
$lang['help_export_intro'] = '<p>You can export all or a subset of the data of the event calendar in two different ways:</p>
<ul>
<li>by choosing the link "export events" in the sponsor\'s options menu</li>
<li>or by directly accessing the export URL<br />
e.g. @@EXPORT_DATA_FORMAT@@</li>
</ul>';
...
# >> Update: Text used by the login-protected interface

# >> Misc
// Displayed when CUSTOM_LOGIN_HTML is true but the custom login file could not be read.
$lang['login_failed_include'] = '<b>Warning:</b> Failed to read <code>static-includes/loginform.inc</code>. Check that file exists and permissions are set correctly.';
...
$lang['change_homepage_description'] = 'Change the default home page address that appears when adding new events.';
...
# >> Notices: These appear on update.php after actions have been successfully completed (e.g. submitted new event).
...
$lang['hompage_changed_notice'] = 'The address of your home page was successfully changed to:';
$lang['email_changed_notice'] = 'Your e-mail address was successfully changed to:';
...
$lang['other_month'] = 'other month';
$lang['months'] = 'months';
$lang['year'] = 'Year';
$lang['every'] = 'every';
$lang['every_other'] = 'every other';
...
$lang['description_description'] = 'A detailed description of the event. To avoid unnecessary calls or e-mails to your office be as detailed as possible.<br />
The description is limited to @@MAXLENGTH_DESCRIPTION@@ total characters<span id="Description_CharLine" class="none">, of which you are using <span id="Description_CurrentChars" class="txtInfo"></span>. Web and e-mail addresses are automatically linked</span>.';
...
$lang['contact_email_description'] = 'Optionally specify an e-mail address or contact web address that can be used to request further information.';
# << Additional Event Information
...
$lang['sponsor_page_web_address'] = 'Sponsor\'s web site';
$lang['button_restore_default'] = 'Restore default';
# << Displayed Sponsor/URL

# >> Submit to Default Calendar
...
$lang['add_new_keyword_pair_instructions'] = 'Do NOT add multiple words.<br />
A keyword (or alternative keyword) cannot contain spaces.';
...
$lang['color_section_description_filternotice'] = 'The colors and background image for a message that appears when the events being displayed are filtered by category or search keyword.';
...
$lang['change_email_label'] = 'The e-mail address you enter below will be used by the calendar administrator to send messages to you:';
$lang['email_invalid'] = 'The e-mail address is invalid.';
$lang['change_homepage'] = 'Change home page address';
$lang['change_homepage_label'] = 'Please enter the address of your organization\'s home page:';
...
$lang['email_account_updated_body'] = 'The calendar administrator updated the information for your user account. The current settings are: ';
...
$lang['email_example'] = '(e.g. jsmith@example.com)';
...
# >> Delete Calendar/Category/Event/Sponsors/Users
...
$lang['choose_email'] = 'Please choose an e-mail address.';
$lang['url_example'] = '(e.g. http://www.example.com/)';
...
$lang['email_add_event_instructions'] = 'Short instructions for adding an event: - Login using your personal user-ID and password - Click on "Add new event" - Fill in the fields - Press the "Preview event" button - If the preview looks ok, press the "Save changes" button Your event is submitted to the calendar administrator for review and will be publicized shortly. ';
# << Add/Edit Sponsors
...
$lang['reccurring_events'] = 'Reccurring Events';
...
$lang['rejected_explanation'] = '&hellip;event was not approved for publication';
$lang['submitted_for_approval_explanation'] = '&hellip;event has yet to be reviewed and approved';
$lang['approved_explanation'] = '&hellip;event is displayed in the calendar';
# << Manage 'My' Events
...
Below you can associate certain search keywords with custom text<br />
messages or HTML. This can be used to answer to keywords which<br />
are frequently used but rarely have a match within the calendar.';
...
$lang['edit_language'] = 'Edit Language File';
$lang['manage_language_files'] = 'Manage language files';
$lang['manage_language_files_description'] = 'Add or modify available calendar language files. These files provide the interface titles, descriptions, and wording used throughout the calendar pages.';
$lang['specify_new_language'] = 'Specify new language';
$lang['specify_language_description'] = 'Select a language file to edit or specify a new one.<br />
<span style="font-weight:normal">(Note: If you add a \'New\' language file you should also add the appropriate <a href="http://tinymce.moxiecode.com/download.php" target="_blank">TinyMCE language pack</a> to the project.)</span>';
$lang['edit_language_instructions'] = '<ul>
<li><a href="http://www.htmlhelp.com/tools/validator/problems.html#amp" target="_blank">Links should be HTML encoded</a> to prevent errors.</li>
<li>Internal links (links that don\'t leave the current web site) should be relative;<br />
rather than using <kbd>http://www.example.com/calendar/main.php?calendarid=default</kbd><br />
you should use <kbd>main.php?calendarid=default</kbd>.</li>
<li>All content should be <a href="http://validator.w3.org/#validate_by_input+with_options" target="_blank">XHTML compliant.</a></li>
<li>Any field that is left blank will use the value of the default language.</li>
</ul><br />';
# << Manage Language Files

# >> Manage Alternate Search Keywords
...
$lang['events_successfully_imported'] = 'events were successfully imported.';
...
$lang['enter_import_url_example'] = '(e.g. &quot;http://www.example.com/rec/newevents.xml&quot;)';
# << Import Events

# >> Help Windows: This is being phased out and the text is instead being included directly on pages
...
$lang['help_signup_authorization'] = 'Authorization to add events can be obtained by contacting the calendar administrator at';
$lang['help_signup_contents'] = 'All event submissions will be reviewed by the calendar coordinator before they are posted. Consequently, it is important to submit items at least two days in advance of the event. During the review process, submissions will be checked to see if they are appropriate for posting, and may be edited for clarity and conciseness.';
# << Help Windows
