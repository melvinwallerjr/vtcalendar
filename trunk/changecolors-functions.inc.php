...
function MakeColorUpdateSQL($calendarid, $type) {
	if ($type == 'insert') {
		return "INSERT INTO vtcal_colors (calendarid"
		...
		. ") VALUES ('" . sqlescape($calendarid) . "'"
			. ",'" . sqlescape($GLOBALS['Color_bg']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_text']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_text_faded']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_text_warning']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_link']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_body']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_today']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_todaylight']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_light_cell_bg']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_table_header_text']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_table_header_bg']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_border']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_keyword_highlight']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_h2']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_h3']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_title']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_tabgrayed_text']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_tabgrayed_bg']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_filternotice_bg']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_filternotice_font']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_filternotice_fontfaded']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_filternotice_bgimage']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_eventbar_past']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_eventbar_current']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_eventbar_future']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_monthdaylabels_past']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_monthdaylabels_current']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_monthdaylabels_future']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_othermonth']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_littlecal_today']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_littlecal_highlight']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_littlecal_fontfaded']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_littlecal_line']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_gobtn_bg']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_gobtn_border']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_newborder']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_newbg']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_approveborder']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_approvebg']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_copyborder']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_copybg']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_deleteborder']) . "'"
			. ",'" . sqlescape($GLOBALS['Color_deletebg']) . "'"
		. ")";
	}
	else {
		return "UPDATE vtcal_colors SET "
			. "bg = '" . sqlescape($GLOBALS['Color_bg']) . "'"
			. ",text = '" . sqlescape($GLOBALS['Color_text']) . "'"
			. ",text_faded = '" . sqlescape($GLOBALS['Color_text_faded']) . "'"
			. ",text_warning = '" . sqlescape($GLOBALS['Color_text_warning']) . "'"
			. ",link = '" . sqlescape($GLOBALS['Color_link']) . "'"
			. ",body = '" . sqlescape($GLOBALS['Color_body']) . "'"
			. ",today = '" . sqlescape($GLOBALS['Color_today']) . "'"
			. ",todaylight = '" . sqlescape($GLOBALS['Color_todaylight']) . "'"
			. ",light_cell_bg = '" . sqlescape($GLOBALS['Color_light_cell_bg']) . "'"
			. ",table_header_text = '" . sqlescape($GLOBALS['Color_table_header_text']) . "'"
			. ",table_header_bg = '" . sqlescape($GLOBALS['Color_table_header_bg']) . "'"
			. ",border = '" . sqlescape($GLOBALS['Color_border']) . "'"
			. ",keyword_highlight = '" . sqlescape($GLOBALS['Color_keyword_highlight']) . "'"
			. ",h2 = '" . sqlescape($GLOBALS['Color_h2']) . "'"
			. ",h3 = '" . sqlescape($GLOBALS['Color_h3']) . "'"
			. ",title = '" . sqlescape($GLOBALS['Color_title']) . "'"
			. ",tabgrayed_text = '" . sqlescape($GLOBALS['Color_tabgrayed_text']) . "'"
			. ",tabgrayed_bg = '" . sqlescape($GLOBALS['Color_tabgrayed_bg']) . "'"
			. ",filternotice_bg = '" . sqlescape($GLOBALS['Color_filternotice_bg']) . "'"
			. ",filternotice_font = '" . sqlescape($GLOBALS['Color_filternotice_font']) . "'"
			. ",filternotice_fontfaded = '" . sqlescape($GLOBALS['Color_filternotice_fontfaded']) . "'"
			. ",filternotice_bgimage = '" . sqlescape($GLOBALS['Color_filternotice_bgimage']) . "'"
			. ",eventbar_past = '" . sqlescape($GLOBALS['Color_eventbar_past']) . "'"
			. ",eventbar_current = '" . sqlescape($GLOBALS['Color_eventbar_current']) . "'"
			. ",eventbar_future = '" . sqlescape($GLOBALS['Color_eventbar_future']) . "'"
			. ",monthdaylabels_past = '" . sqlescape($GLOBALS['Color_monthdaylabels_past']) . "'"
			. ",monthdaylabels_current = '" . sqlescape($GLOBALS['Color_monthdaylabels_current']) . "'"
			. ",monthdaylabels_future = '" . sqlescape($GLOBALS['Color_monthdaylabels_future']) . "'"
			. ",othermonth = '" . sqlescape($GLOBALS['Color_othermonth']) . "'"
			. ",littlecal_today = '" . sqlescape($GLOBALS['Color_littlecal_today']) . "'"
			. ",littlecal_highlight = '" . sqlescape($GLOBALS['Color_littlecal_highlight']) . "'"
			. ",littlecal_fontfaded = '" . sqlescape($GLOBALS['Color_littlecal_fontfaded']) . "'"
			. ",littlecal_line = '" . sqlescape($GLOBALS['Color_littlecal_line']) . "'"
			. ",gobtn_bg = '" . sqlescape($GLOBALS['Color_gobtn_bg']) . "'"
			. ",gobtn_border = '" . sqlescape($GLOBALS['Color_gobtn_border']) . "'"
			. ",newborder = '" . sqlescape($GLOBALS['Color_newborder']) . "'"
			. ",newbg = '" . sqlescape($GLOBALS['Color_newbg']) . "'"
			. ",approveborder = '" . sqlescape($GLOBALS['Color_approveborder']) . "'"
			. ",approvebg = '" . sqlescape($GLOBALS['Color_approvebg']) . "'"
			. ",copyborder = '" . sqlescape($GLOBALS['Color_copyborder']) . "'"
			. ",copybg = '" . sqlescape($GLOBALS['Color_copybg']) . "'"
			. ",deleteborder = '" . sqlescape($GLOBALS['Color_deleteborder']) . "'"
			. ",deletebg = '" . sqlescape($GLOBALS['Color_deletebg']) . "'"
