...
if ( !is_string($result) && $result->numRows() > 0 ) {
	echo '<a href="main.php?calendarid='.urlencode($_SESSION["CALENDARID"]).'&view=day&amp;timebegin=', urlencode(datetime2timestamp($event_timebegin['year'],$event_timebegin['month'],$event_timebegin['day'],12,0,"am")) . $queryStringExtension . '">';
