...
<?php
$result =& DBQuery("SELECT * FROM vtcal_searchlog WHERE calendarid='".sqlescape($_SESSION["CALENDARID"])."' AND time >= '" . $rangestartTimestamp . "' AND time <= '" . $rangeendTimestamp . "' ORDER BY time DESC"); 
